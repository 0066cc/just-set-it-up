...
alias ytd=' youtube-dl -f 135+bestaudio --merge-output-format mkv -R "infinite" -c --console-title --no-call-home --embed-thumbnail'
alias m='make'
...
alias lofi2="mpv https://www.youtube.com/watch?v=pKmhzKSwHC8"
alias lofi3="mpv https://www.youtube.com/watch?v=BFUQ6sAYgO8"
...
alias 90sweb="sudo wondershaper wlp3s0 96 96"
alias getonline="nmtui"
alias aspell="aspell -x "
alias zotero="bash /usr/bin/Zotero_linux-x86_64/zotero-bin"
...
alias 90sclear="sudo wondershaper clear wlp3s0"
alias news="newsboat"
alias w3m="w3m -T text/HTML -cols 80 -o auto_image=TRUE -num -no-mouse "
alias ddg="w3m -T text/HTML -cols 80 -o auto_image=TRUE -num -no-mouse https://duckduckgo.com/lite/ "
alias jp="git add * ; git commit -m \"Update\" ; git push origin main"
alias kr="indent -kr --tab-size8"
