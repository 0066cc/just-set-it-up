...
c.content.user_stylesheets = [ "userContent.css", "block.css"]
config.unbind("q")
...
config.bind('<Ctrl-Shift-y>', 'hint links spawn --detach mpv --force-window yes --no-video {hint-url}')
#config.bind('<Ctrl-Shift-y>', 'hint links spawn --detach tizonia --youtube-audio-stream {hint-url}')
