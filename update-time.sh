#!/bin/bash
curl https://raw.githubusercontent.com/0066cc/Dotfiles/master/.bashrc ~/.bashrc ;
curl https://raw.githubusercontent.com/0066cc/Dotfiles/master/.tmux.conf ~/.tmux.conf ;
